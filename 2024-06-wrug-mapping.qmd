...
::: {.column width="50%"}
(Vectors) According to their geometry:

-   **Points** expressed as pairs of `lat, long`, or `x, y` (i.e. markers).
-   **Lines** edges connecting (i.e. streets)
...
-   **Static visualisation**
    ...
    -   [`{mapsf}`](https://riatelab.github.io/mapsf/articles/mapsf.html)
...
##  {#map-heatmap2 data-menu-title="Heatmap" background-image="img/heatmap.png"}

##  {#map-facets2 data-menu-title="Facets" background-image="img/map-facets.png"}

##  {#tmap-composite data-menu-title="Composite" background-image="img/tmap-example-composite.png"}

##  {#tmap-theming data-menu-title="Theming" background-image="img/tmap-example-theming.png"}
...
Beyond creating a beautiful map very quickly and easily, there are more benefits:
